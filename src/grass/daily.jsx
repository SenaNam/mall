...
#03. [이랑님] 어드민,유져> 배너 > EX탭 추가, 화면에서 다수 배너 사라짐 확인 필요
#04. 컨텐츠 디자인
...
#00. [선희님] 001m Null어블하게 변경할 컬럼들 체크하여 전달 => 널널로 변경 => 완료
#00. [이책임님] 맵퍼 암복화 적용되었으므로 맵퍼에서 기존컬럼명 As 이전명으로 변경 => 완료
#00. 배너 레이아웃 수정
#00. 페이고스 랜딩 서비스 카드 스와이퍼로 수정
#00. 배너 상태별 출력 수정
#00. 이벤트 배너 레이아웃 수정중...
#00. [유져] IBK로그인 페이지 -> 문구 수정 => 완료
...
[차순위 업무]
#01. 담당자 정보 Not Null로 변경 => 약정할때 필요하다
#02. cmi002 테이블에 EAI에서 insert 해줄때 FRRG_ID, LSMD_ID 생성순서로 리턴해주는데 이거 뭐라고 입력받을지 확인 필요
#03. 테스트 계정, 테스트 DB에 전체 insert

[상기4건 처리 후 진행]
#00. 알러트 메세지 상수화 선언된걸로 변경
