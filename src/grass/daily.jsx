...
[차순위 업무]
#11. [이랑님] 어드민 > 배너 > 대기상태 -> DB랑 화면이랑 맞지 않음 확인 요청
#01. [김우철과장님] 어드민 > 파일용량 확장 체크하여 전달 해주기로함 => 안줌
#02. 페이고스 랜딩 배너 레이아웃 수정 =>  중배너, 대배너 수정해야함
#03. [대표님] 에러메세지 검토 수행사 수정 =>    
#04. API연동관리 > 페이팔 
...
#00. 어드민 >  페이지 새창 보기 사이즈 전부다 크게 수정 
