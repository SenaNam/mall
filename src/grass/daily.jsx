...
#01. API연동관리 > Auth 수정/테스트건
    ...
    - [이랑님] 국내 오픈마켓 해외 오픈마켓과 동일하게 레이아웃 수정
#07. 페이고스 랜딩 배너 레이아웃 수정 => 완료
#00. [유져] 국내 오픈마켓도 해외 오픈마켓과 동일한 포맷으로 
#00. [유져] 자주하는 질문 내용 깨지는건 수정 => 이랑님 전달 => 완료
#01. API연동관리 > Auth 수정/테스트건 -> ㅜㅜ
- 페이팔 Auth테스트 -> 화면수정이 남았다고 함
- 연결해제 버튼 디자인 수정
#01. 담당자 정보 Not Null로 변경 => 약정할때 필요하다?
#00. 알러트 메세지 상수화 선언된걸로 변경 ->흑흑
#00. [선희님] 사용자 메세지 문서화 파일 전달 => 이랑님 전달 
 - 이책임님 상수 정의후 정리 예정
 - 사용자에게 전달되는 alert 메세지 목록화 작성
 - 랜딩 등과 같이 특정 상황에 대해 메세지 띄어지는 경우 확인     
 - 알러트 및 수정, 확인등 전체
#00. API연동관리 > 
#00. [유져] > 외부망에서 배너 노출 안되는 문제 수정
#00. [김우철과장님] 페이팔 연동하기 눌렀을때 샌드박스 모드가 뜨도록 변경 해달라
#00. 
