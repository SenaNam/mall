[12.03일 완료 - 해결(이관)된 이슈]


[차순위 업무 > 상기 처리 후 진행 - 중요]
#00. [대표님] 유져 > 디수정 랜딩 > 디수정 바로 시작하기 버튼 링크 수정 => 완료
#00. [대표님] 유져 > 사용자 화면에서 로그아웃 되면 기업인뱅 로그아웃 화면이 보여짐 -> 원래대로 롤백해달라 ..?
...
#00. 어드민 > 게시판 파일 다운로드 수정


#01. 어드민 게시판 배포판 파일 등록 안됨 -> NAS경로 설정 에러 있음 => 수정완료 => 배포 하면 적용됨 내용 확인해야함
...
#00. 유져 > 공개범위가 비공개인데 보인다함?


#00. 어드민에서 새탭열기시 SSO를 타고, 새탭열기시 URL 열릴때 어떻게 처리할지
#00. SSO는 PC면 탭 상관없이 대여야 한다 ==> 유져정보 토큰때문에 로컬스토리지로 옮겨서 토큰도 공유 하도록 수정 
#00. 유져 > 파일다운 가능하게 수정
#00. 프론트 라우팅 => 
#00. 유져 > 랜딩에서 메세지 2번뜨는것
------------------------------------------------------------------------
[이슈 및 확인사항]
