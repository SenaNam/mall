...
- [선희님] SQL과 인터페이스 > 프로그램명세서 단위테스트 목록 작성
- [어드민] 신청서 (마감) 옆에 삭제 기능 개발 / 화면 추가 => 완료
    - DEL_YN 컬럼없음 / 노출여부 컬럼 Y/N/D 로 D상태를 삭제상태로 취급 => 완료
- PAYGOS랜딩의 이벤트 배너 출력 잡아줘야함
- [김우철과장님:유져/어드민] 세션 타이머 연장은 마우스 클릭,스크롤 키보드 누름 일때만 갱신
