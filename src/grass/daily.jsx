...
#00. [선희님] 유져 > 계좌관리 기본 화면 표 형태로 출력하게 수정
#00. 어드민 > 게시판 파일 다운로드 과


#01. 어드민 게시판 배포판 파일 등록 안됨 -> NAS경로 설정 에러 있음 => 수정완료 => 배포 하면 적용됨 내용 확인해야함
#02. [김우철과장님] 어드민 > 파일용량 확장 체크하여 전달 해주기로함 => 확장자 제한X, 50MB이하
...
------------------------------------------------------------------------
[이슈 및 확인사항]
#00. 유져 > 모바일 랜딩 : 탭하여 활성화 수정, 버튼 워딩, PC랑 동일하게 수정 
#00. 유져 > 배너에서 클릭되는 URL이 공지및 게시물일때 잘 이동 되는가
#00. 어드민 > 배너 > 순서 조절 이미지 출력
#00. 어드민 > 배너 디테일 화면에서 인풋 박스 전부 디스어블 처
#00. 유져 > 공지사항 출력이 안됨 > 왜? > http: 보호라우터를 걸었기때문
