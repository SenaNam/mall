[해결(이관)된 이슈]
[11.26(수) 작업일지]
#01. 익일 권한관리 수정 반영 확인후 페이고스방에 공지 (11.25) => 백엔드죽어서 확인 못함 => 아니다 살아있을떄 확인함
#00. 어드민 > 오버뷰페이지 => 테이블 키없음 => 전달 완료

[11.26(수) 금일 수행 업무] 
#01. API연동관리 > 페이팔 > Auth 수정/테스트건 => 재조회 화면 버튼 삭제 완료
...
#08. [IBK요청] 유져 > 메뉴 통합 > 해외마켓/국내마켓 별 통합 메뉴
    ...
    - 연동중 상태 DB조회 로직으로 수정
#00. 배너 요구사항 명세서 옴
#00. [이랑님] 유져 > 랜딩 공지사항 > 자세히보기 새창 수정 => 완료
#00. [이랑님] 유져 > 가이드 > 파일 출력 수정 => 다운로드 가능 => 완료
#00. [이랑님] 아마존 API 연동상태 확인/연동하기/연동해제 화면 수정 > 지금 리젼을 못가지고 간다 => 수정완료
#00. 유져 > 공지사항 및 게시판 파일 다운로드 안됨 수정 => 완료
#00. [부장님] 권한관리 백엔드 bodyrequest 확인 => NPE 수정 완료
#00. 유져 > 자주 하는 질문 > 제목 수정 => 이랑님 전달 DB 이전후 작성 예정
#00. [이랑님] 유져 > 해외오픈마켓에 갱신버튼, 만료날짜 없어졌음 => 확인(API연결전이라서 갱신도 만료날짜도 없음) => 완료                                                                                                                                                                                                                                                   
#00. [IBK요청] 유져 > 메뉴 통합 > 해외마켓/국내마켓 별 통합 메뉴 => 완료
